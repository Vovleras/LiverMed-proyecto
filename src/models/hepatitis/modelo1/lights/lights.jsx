...
const Lights = () => {
  const mainLightRef = useRef(); // CORREGIDO: Usar mainLightRef en lugar de directionalLightRef
  ...
  return (
    <>
      {/* Ejemplo de luces que podías usar antes
      <SpotLight
        ref={spotLightRef}
        color={"red"}
        position={[4, 2, -2]}
      ...
      */}
      ...
      {/* Aquí asignamos ref a la luz que queremos animar */}
      <directionalLight
        ref={mainLightRef}
        position={[0, 5, -5]}
        intensity={8}
